...
\includegraphics[width=26.24in]{pics/sd_vs_mean_v1} \hfill{}
...
\includegraphics[width=26.24in]{pics/mean_window_v1} \hfill{}

\caption{Mean Rewards per step during training (1,000 step sliding window).}\label{fig:training-mean-window}
\end{figure}
...
{\centering \includegraphics[width=26.24in]{pics/loss_v1} 
