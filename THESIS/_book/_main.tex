...
The particular environment that was used for this thesis is as follows:
...
\item
  \url{https://github.com/elbecerrasoto/CARL} for DQN implementations.
\end{enumerate}
