...
Referencing chapeter 2: @ref(cellular automata)

\begin{longtable}[]{@{}llll@{}}
\caption{How different models handle \emph{state}, \emph{space} and \emph{time}. \emph{C} stands for continuous and \emph{D} for discrete. Table taken from the book ``Simulating complex systems by cellular automata'' (Hoekstra, Kroc, and Sloot \protect\hyperlink{ref-hoekstra2010simulating}{2010}).}\tabularnewline
\toprule
...
\hypertarget{cellular-automata-applications}{%
\subsection{Cellular Automata Applications}\label{cellular-automata-applications}}
