...
```{r A1, fig.cap='(ref:A1)', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
knitr::include_graphics('pics/A1.png')
```

(ref:A2) Diagram of Architecture 2 (A2).
```{r A2, fig.cap='(ref:A2)', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
knitr::include_graphics('pics/A2.png')
```

(ref:A3) Diagram of Architecture 3 (A3).
```{r A3, fig.cap='(ref:A3)', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE}
...
```{r sd-vs-mean, fig.cap='(ref:sd-vs-mean)', fig.align='left', echo=FALSE}
knitr::include_graphics('pics/sd_vs_mean_v1.png')
```

(ref:training-mean-window) Mean Rewards per step during training (1,000 step sliding window).
```{r training-mean-window, fig.cap='(ref:training-mean-window)', fig.align='left', echo=FALSE}
knitr::include_graphics('pics/mean_window_v1.png')
```
...
```{r loss, fig.cap='(ref:loss)', fig.align='center', echo=FALSE}
knitr::include_graphics('pics/loss_v1.png')
```
