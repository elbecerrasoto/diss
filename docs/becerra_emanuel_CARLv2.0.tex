...
In the scope of RL, a widely accepted benchmark is the Arcade Learning Environment (ALE) (Bellemare et al. \protect\hyperlink{ref-bellemare2013arcade}{2013}). ALE is a suite of more than fifty games from the Atari 2600 console. Moreover, frameworks such as Open AI Gym (Brockman et al. \protect\hyperlink{ref-1606.01540}{2016}) have lowered the barrier entry for using ALE, making Atari games easily accessible for RL algorithms and their training and evaluation. ALE's primary strengths are its variety of tasks and the independent creation of each game which reduces the bias of a single manufacturer. If a single algorithm is capable of performing well on a variety of very different and difficult tasks, it would be conceivable to claim its generality, this notion is captured on ALE as challenge for any relatively general RL algorithm to play well on, as many as possible, Atari games. A key event for the popularization of Atari games as a benchmark was their utilization on the seminal Deep Q-Networks (DQN) papers (Mnih et al. \protect\hyperlink{ref-mnih2013playing}{2013})(Mnih et al. \protect\hyperlink{ref-mnih2015human}{2015}). DQN achieved a remarkable performance on a dozen of Atari games, receiving as input just raw pixels, without any semantic understanding of the games and a single set of hyperparameters. DQN revived the interest in DRL methods.
...
The comparison of the obtained \emph{mean reward per step} and \emph{reward standard deviation} is shown in Figure \ref{fig:sd-mean}. It can be observed that the best runs (\(c,a,d,i,g\)) also have an smaller \emph{standard deviation}.



\begin{figure}

{\centering \includegraphics{becerra_emanuel_CARLv2.0_files/figure-latex/sd-mean-1} 
...
{\centering \includegraphics{becerra_emanuel_CARLv2.0_files/figure-latex/sd-mean-epsilon-1} 
...
{\centering \includegraphics{becerra_emanuel_CARLv2.0_files/figure-latex/reward-dynamics-1} 
...
{\centering \includegraphics{becerra_emanuel_CARLv2.0_files/figure-latex/loss-1} 
