...
\newenvironment{dontprintpagenumber}
{\pagestyle{empty}}
...
\caption{\label{tab:hyper}Comparison of obtained returns from the nine runs. The return was computed from playing 100,000 steps per run following the learned policy. The runs are ordered from best to worst and are named from $a$ to $i$, the "heuristic" and "random" baselines are marked as "H" and "R" respectively.}
\centering
\resizebox{\linewidth}{!}{
...
{\centering \includegraphics{becerra_emanuel_CARLv2.1_files/figure-latex/sd-mean-1} 
...
{\centering \includegraphics{becerra_emanuel_CARLv2.1_files/figure-latex/sd-mean-epsilon-1} 
...
{\centering \includegraphics{becerra_emanuel_CARLv2.1_files/figure-latex/reward-dynamics-1} 
...
{\centering \includegraphics{becerra_emanuel_CARLv2.1_files/figure-latex/loss-1} 
